...
<!-- Delete the rows you don't use and add the ones you do. -->
...
- **Tools:** ArcGIS Pro
- 🔗 [View the StoryMap](https://arcg.is/0Dzmvi0)


### 2. Optimal Pipeline Routing
...
Identifying commodity concession mismatches in Indonesia — uncovering where
